...
import AdminPanelBodyTableComponent from '../AdminPanelBodyTableComponent/AdminPanelBodyTableComponent';
            ...
            <div className="adminPanelHomePageContainer">
                ...
                <div className="adminPanelHomePageBodyContainer">
                    ...
                    <div className="adminPanelBodyContainer">
                        <div>
                            <h1>Admin Panel</h1>
                            <AdminPanelBodyTableComponent data={tableData} columnHeaders={columnHeaders} />
                        </div>
                    </div>
                </div>
            </div>
