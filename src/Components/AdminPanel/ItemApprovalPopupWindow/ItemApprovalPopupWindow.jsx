...
const ItemApprovalPopupWindow = ({ selectedRowData, onClose }) => {
    const imageArray = [
        'http://localhost:80/RentIT/' + selectedRowData.item_Picture_01.slice(3),
        'http://localhost:80/RentIT/' + selectedRowData.item_Picture_02.slice(3),
        'http://localhost:80/RentIT/' + selectedRowData.item_Picture_03.slice(3),
        'http://localhost:80/RentIT/' + selectedRowData.item_Picture_04.slice(3),
        'http://localhost:80/RentIT/' + selectedRowData.item_Picture_05.slice(3)
    ]
